...
###############################################################################
class MaxSupply(Scenario):
    """
    The first runner 0 runs CBM without any disturbances events for the future period.
    The disturbances for the historical period remain.

    The second runner 1 runs CBM with disturbances amounts in tons of
    carbon corresponding exactly to the increment over the period.
    """

    short_name = 'max_supply'
