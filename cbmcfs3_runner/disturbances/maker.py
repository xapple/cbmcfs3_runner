...
class DisturbanceMaker(object):
    ...
    def disturbance_events_raw(self):
        """ Note: self.country.orig_data.disturbance_events
        was filtered, and here we are before the creation of input data.
    ...
    def dist_irw(self):
        ...
        ['hwp', 'year_text', 'value_ob', 'year_max', 'year', 'step',
         ...
         'stock_available', 'stock_tot', 'prop', 'db', 'value_tc', 'amount_m3',
    ...
    def dist_fw_converted(self):
        ...
        df = self.dist_fw
        df['amount_total'] = (df['amount_m3'] * (1 + df['snag_perc'] + df['owc_perc']))
