...
Typically you would run this file from a command line like this:
     ...
     ipython3.exe -i -- /deploy/cbmcfs3_runner/scripts/orig/add_999_to_dist_id.py
"""
...
class Add999ToDistID(object):
    ...
    def __call__(self):
        ...
        # Add 100 #
        self.dup[col_name] = self.dup[col_name].apply(lambda x: '999' + x)
        # Add 'Future' #
        pass
        # Write back to disk #
...
if __name__ == '__main__':
    modifiers = [Add999ToDistID(c) for c in continent]
